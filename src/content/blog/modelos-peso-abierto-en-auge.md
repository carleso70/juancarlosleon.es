...
Lo que sí ha cambiado es lo que hay dentro. En diez minutos tenía un modelo respondiendo preguntas en la terminal (mis preguntas absurdas), usando mi CPU/GPU y mi RAM, sin pasar por ninguna API de pago ni mandar un solo dato a ningún servidor ajeno, con una calidad mejorada, aunque tampoco esperes que sea el más rápido en desenfundar, todo sea dicho...
