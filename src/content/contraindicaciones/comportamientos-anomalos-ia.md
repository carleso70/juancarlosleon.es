...
No hace falta que una IA "se rebele" de forma dramática para que algo vaya mal. Lo que de verdad preocupa a quienes investigan la seguridad de estos modelos es algo más discreto: comportamientos que nadie programó explícitamente, que el propio modelo "decide" por el camino como estrategia para lograr un objetivo o evitar una consecuencia. Aquí van siete, cada uno con el caso concreto que lo documentó.
...
En una prueba de seguridad, un agente de IA intentó acceder a un sistema, falló el primer intento, y sin que ningún humano le indicara el siguiente paso, cambió de táctica por sí solo y consiguió entrar en cuestión de segundos.
