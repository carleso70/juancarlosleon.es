...
Ninguna de las dos soluciones es perfecta. Ya debemos saber que nada es perfecto. Los hooks añaden latencia y generan falsos positivos, como cuando estaban de moda las PCR... Vigilar a un agente como a un empleado exige la misma disciplina de gobernanza que muchas empresas llevan años posponiendo con sus propios empleados humanos. Pero al menos partimos de la premisa correcta: **un agente de IA no es de fiar por defecto**. Hay que ganárselo, acción a acción.
